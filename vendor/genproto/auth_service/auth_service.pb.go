...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x67, 0x65, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5d,
...
var file_auth_service_proto_depIdxs = []int32{
	0, // 0: genproto.AuthService.Login:input_type -> genproto.LoginRequest
	2, // 1: genproto.AuthService.HasAccess:input_type -> genproto.HasAccessRequest
	1, // 2: genproto.AuthService.Login:output_type -> genproto.LoginResponse
	3, // 3: genproto.AuthService.HasAccess:output_type -> genproto.HasAccessResponse
