...
var file_shipper_service_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x73, 0x32, 0xaa, 0x05, 0x0a, 0x0e, 0x53, 0x68, 0x69, 0x70, 0x70, 0x65, 0x72,
	...
	0x70, 0x70, 0x65, 0x72, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x42, 0x79, 0x43,
	0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x12, 0x11, 0x2e, 0x67, 0x65, 0x6e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x68, 0x69, 0x70, 0x70, 0x65, 0x72, 0x1a, 0x11, 0x2e,
	0x67, 0x65, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x68, 0x69, 0x70, 0x70, 0x65, 0x72,
	0x22, 0x00, 0x12, 0x3d, 0x0a, 0x0e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x61, 0x73, 0x73,
	0x77, 0x6f, 0x72, 0x64, 0x12, 0x11, 0x2e, 0x67, 0x65, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
	0x53, 0x68, 0x69, 0x70, 0x70, 0x65, 0x72, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
...
var file_shipper_service_proto_depIdxs = []int32{
	...
	11, // 13: genproto.ShipperService.GetByCredentials:input_type -> genproto.Shipper
	11, // 14: genproto.ShipperService.ChangePassword:input_type -> genproto.Shipper
	1,  // 15: genproto.ShipperService.CreateShipper:output_type -> genproto.CreateShipperResponse
	3,  // 16: genproto.ShipperService.GetShipper:output_type -> genproto.GetShipperResponse
	5,  // 17: genproto.ShipperService.GetAllShippers:output_type -> genproto.GetAllShippersResponse
	7,  // 18: genproto.ShipperService.UpdateShipper:output_type -> genproto.UpdateShipperResponse
	12, // 19: genproto.ShipperService.DeleteShipper:output_type -> google.protobuf.Empty
	10, // 20: genproto.ShipperService.ExistsShipper:output_type -> genproto.ExistsShipperResponse
	11, // 21: genproto.ShipperService.GetByLogin:output_type -> genproto.Shipper
	11, // 22: genproto.ShipperService.GetByCredentials:output_type -> genproto.Shipper
	12, // 23: genproto.ShipperService.ChangePassword:output_type -> google.protobuf.Empty
...
type ShipperServiceClient interface {
	...
	GetByCredentials(ctx context.Context, in *Shipper, opts ...grpc.CallOption) (*Shipper, error)
...
func (c *shipperServiceClient) GetByCredentials(ctx context.Context, in *Shipper, opts ...grpc.CallOption) (*Shipper, error) {
	out := new(Shipper)
	err := c.cc.Invoke(ctx, "/genproto.ShipperService/GetByCredentials", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShipperServiceServer interface {
	...
	GetByCredentials(context.Context, *Shipper) (*Shipper, error)
...
func (*UnimplementedShipperServiceServer) GetByCredentials(context.Context, *Shipper) (*Shipper, error) {
...
func _ShipperService_GetByCredentials_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Shipper)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShipperServiceServer).GetByCredentials(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/genproto.ShipperService/GetByCredentials",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShipperServiceServer).GetByCredentials(ctx, req.(*Shipper))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ShipperService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ShipperService_GetByCredentials_Handler,
		},
		{
