...
//	}
//
//	if userInfo.UserType == config.RoleCargoOwnerAdmin {
//		coID = userInfo.ID
//	} else if userInfo.UserType == config.RoleAdmin {
//		coID = c.Query("co_id")
//	}
//
...
//	}
//
//	token, err := jwt.GenerateJWT(userInfo.ID, userInfo.UserType, signingKey)
//
//	if handleBadRequestErrWithMessage(c, h.log, err, "error while generating token") {
//		return
//	}
