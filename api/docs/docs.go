...
// 2020-04-20 00:26:18.356447241 +0500 +05 m=+0.081320942
...
var doc = `{
    ...
    "paths": {
        ...
        "/v1/gettotaldeliverycost/limit_distance/{limit_distance}/initial_price/{initial_price}/unit_price/{unit_price}/distance/{distance}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.GetTotalDeliveryCost"
                        }
                    },
                    "404": {
                        "description": "Not Found",
